...
const AuthModal = ({ children }: Readonly<{ children: React.ReactNode }>) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-300 via-teal-300 to-blue-300 flex items-center justify-center p-4">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-3 mb-12">
              <Image
                ...
                width={50}
              />
              <span className="font-bold text-3xl">Coinwise</span>
            </div>
            {/** Headline */}
