...
const TransactionList = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-blue-50 relative overflow-hidden">
      {/* Header */}
      <div className="bg-transparent sticky top-0 z-10 p-4">
        <div className="flex items-center justify-between max-w-7xl mx-auto px-4 py-4">
          ...
          <div className="flex items-center gap-3">
            <Link href="/login">
              <button className="px-5 py-2 text-emerald-600 font-medium hover:text-emerald-700 transition-colors">
                Log in
              </button>
              <span className="text-emerald-500">|</span>
            </Link>
            <Link href="/signup">
              <button className="px-5 py-2 bg-transparent text-emerald-600 font-bold border border-emerald-600 rounded-3xl hover:bg-emerald-700 hover:text-white transition-colors cursor-pointer">
                Register
              </button>
            </Link>
          </div>
