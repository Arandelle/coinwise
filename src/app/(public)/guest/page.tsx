...
const TransactionList = () => {
  ...
  const calculateBalance = (index: number) => {
    const totalSpent = transactions.slice(0, index + 1).reduce((sum, tx) => sum + Math.abs(tx.amount), 0);
  ...
  const handleCategoryChange = (categoryName: string) => {
    ...
    if (cat) {
      setFormData({ ...formData, category: categoryName, icon: cat.icon, color: cat.color });
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-100 via-teal-100 to-blue-100">
      {/* Header */}
      <div className="bg-gradient-to-r from-emerald-500 to-teal-500 sticky top-0 z-10 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-white">Coinwise</h1>
          ...
          <div className="hidden lg:block lg:col-span-3 space-y-6">
            <div className="bg-white rounded-xl p-6 shadow-md sticky top-24">
              <div className="flex flex-col items-center">
                ...
                <h3 className="font-semibold text-lg text-gray-900">Welcome back!</h3>
                ...
                <div className="w-full space-y-3 mt-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gradient-to-r from-rose-50 to-red-50 rounded-lg">
                    ...
                    <span className="text-sm font-semibold text-rose-500">₱{totalSpent.toLocaleString()}</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-gradient-to-r from-emerald-50 to-green-50 rounded-lg">
                    <span className="text-sm text-gray-600">Remaining</span>
                    <span className="text-sm font-semibold text-emerald-600">₱{remaining.toLocaleString()}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md">
              ...
              <div className="border-b px-4 flex items-center justify-between">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-emerald-500 via-teal-500 to-blue-500 text-white p-2 rounded-full hover:shadow-lg transition-shadow"
                >
                  <Plus size={20} />
                </button>
              </div>
              ...
              <div className="p-4 space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto">
                {Object.keys(groupedTransactions).length === 0 ? (
                  <p className="text-center text-gray-500 py-8">No transactions yet. Click + to add one!</p>
                ) : (
                    ...
                    <section key={idx} className="space-y-2">
                      <div className="flex flex-row items-center justify-between bg-gradient-to-r from-gray-100 to-gray-50 rounded-xl p-3">
                        ...
                        <p className="text-xs text-rose-600 font-semibold">
                          ₱{txs.reduce((sum, tx) => sum + Math.abs(tx.amount), 0).toLocaleString()}
                        </p>
                      </div>
                      ...
                      {txs.map((transaction, tidx) => {
                        ...
                        return (
                          <div key={tidx} className="flex items-center gap-3 p-3 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-teal-50 rounded-lg transition-all group">
                            ...
                            <div className="flex flex-row justify-between w-full items-center">
                              ...
                              <div className="flex items-center gap-2">
                                <div className="flex flex-col items-end">
                                  <p className="text-sm text-rose-500 font-semibold">₱{transaction.amount.toLocaleString()}</p>
                                  <p className="text-xs text-gray-500">Balance: ₱{calculateBalance(txIndex).toLocaleString()}</p>
                                </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="bg-gradient-to-br from-emerald-500 via-teal-500 to-blue-500 rounded-xl p-6 shadow-md text-white">
              ...
              <p className="text-sm text-emerald-50 mb-4">
                Your spending pattern looks healthy! Keep tracking to maintain your budget goals.
              </p>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-semibold text-lg text-gray-900">Weekly Challenges</h3>
              </div>
              
              <div className="space-y-4">
                <div className="border-l-4 border-emerald-500 pl-4 py-2">
                  <p className="text-sm font-medium text-gray-900">No dining out for 3 days</p>
                  <div className="flex items-center gap-2 mt-2">
                    <div className="flex-1 bg-gray-200 rounded-full h-2">
                      <div className="bg-gradient-to-r from-emerald-500 to-teal-500 h-2 rounded-full" style={{width: '66%'}}></div>
                    </div>
                ...
                <div className="border-l-4 border-blue-500 pl-4 py-2">
                  <p className="text-sm font-medium text-gray-900">Save ₱500 this week</p>
                  <div className="flex items-center gap-2 mt-2">
                    <div className="flex-1 bg-gray-200 rounded-full h-2">
                      <div className="bg-gradient-to-r from-teal-500 to-blue-500 h-2 rounded-full" style={{width: '40%'}}></div>
                    </div>
            ...
            {/* Category Breakdown */}
            <div className="bg-white rounded-xl p-6 shadow-md">
              <h3 className="font-semibold text-lg text-gray-900 mb-4">Top Categories</h3>
