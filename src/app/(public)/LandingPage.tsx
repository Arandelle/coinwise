...
import { TrendingUp, Target, Zap, Brain, Users, Shield, ChevronDown, Menu, X } from 'lucide-react';
...
export default function CoinWiseLanding() {
  ...
  const features = [
    {
      ...
      description: "Get personalized recommendations and smart alerts about your spending patterns. Our AI learns your habits and helps you save more.",
      color: "from-purple-500 to-indigo-500"
    },
    {
      icon: <TrendingUp className="w-8 h-8" />,
      title: "Real-Time Tracking",
      description: "Track every expense effortlessly. See where your money goes with beautiful visualizations and instant categorization.",
      color: "from-emerald-500 to-teal-500"
    },
    {
      icon: <Target className="w-8 h-8" />,
      title: "Smart Goal Setting",
      description: "Set financial goals and watch your progress. Emergency fund, vacation, or dream home - we'll help you get there faster.",
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Community Challenges",
      description: "Join savings challenges with friends. Stay motivated with accountability partners and celebrate milestones together.",
      color: "from-pink-500 to-rose-500"
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Budget Optimizer",
      description: "Automatically optimize your budget allocation. Get suggestions to cut costs and maximize your savings potential.",
      color: "from-amber-500 to-orange-500"
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Bank-Level Security",
      description: "Your financial data is encrypted and secure. We never share your information and use industry-standard protection.",
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <button className="px-6 py-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-lg hover:shadow-lg transition-all duration-200">
                Get Started
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full mb-6 shadow-sm">
              ...
              <span className="text-sm font-semibold text-slate-700">AI-Powered Financial Tracking</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Powerful features designed to make budgeting effortless and actually enjoyable
            </p>
          </div>
      ...
      <section id="how-it-works" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 to-emerald-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
              Simple. Smart. Effective.
            </h2>
            <p className="text-xl text-slate-600">Get started in just 3 easy steps</p>
          </div>
            ...
            {[
              {
                ...
                description: "Securely link your bank accounts or add expenses manually. We use bank-level encryption to keep your data safe.",
                icon: "🔗"
              },
              {
                step: "02",
              ...
              },
              {
                ...
                description: "Get real-time insights, smart alerts, and actionable tips. Track your progress and celebrate every milestone.",
                icon: "📈"
              }
            ].map((item, index) => (
              <div key={index} className="text-center">
                <div className="text-6xl mb-6">{item.icon}</div>
                <div className="text-emerald-600 font-bold text-lg mb-3">STEP {item.step}</div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-gradient-to-br from-emerald-50 to-teal-50 p-8 rounded-2xl border border-emerald-200">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-emerald-600 via-teal-600 to-blue-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-emerald-100 mb-10">
            Join 50,000+ users who are already building their financial future with CoinWise
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm">Making financial wellness accessible to everyone.</p>
            </div>
            <div>
